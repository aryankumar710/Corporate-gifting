          ...
          <div class="seller">
            <div class="d-flex align-items-center  px-3">
              <div>
                ...
                <button class="btn  btn-outline-primary btn-sm px-5 mt-2 " type="button">Post Buy
                  Requirement</button>
              </div>
            </div>
          </div>
            ...
            <div class=" d-flex align-items-center px-3">
              <div>
                <h3 class="col-md-10">Want to grow your
                  business faster</h3>
                <button class="btn  btn-outline-primary btn-md px-5 mt-2" type="button">Sell on Company
                  Name</button>
              </div>
            </div>
          </div>
    ...
    <div class="container">
      ...
      <div class="row rowcategory">
        <div class="owl-carousel categorycarousel owl-theme">
          <div class="item">
            <a class="text-decoration-none" href="CategoryYouMayLike.html">
              <div class="card  p-4">
      ...
      <div class="row">
        <div class="d-flex justify-content-center col-lg-2 col-md-3 col-6 p-3">
          <div class="d-flex flex-column align-items-center ">
            <a href="ProductsByCity.html " class="text-decoration-none city-name">

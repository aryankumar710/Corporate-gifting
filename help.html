  ...
  <section>
    <div class="container">
        <h3 class="mt-4">Help</h3>
            <div>
                <div class="help extra-line"></div>
            <hr>
            </div>
            
            <div class="row">
              <div class="sidebar col-md-4 mt-4">
                <a href="#" class="active" onclick="showTab('tab1', this)">Buyers Help</a>
                <a href="#" onclick="showTab('tab2', this)">Sellers Help</a>
                <a href="#" onclick="showTab('tab3', this)">Account</a>
                <a href="#" onclick="showTab('tab4', this)">Search Help</a>
                <a href="#" onclick="showTab('tab5', this)">Tenders</a>
                <a href="#" onclick="showTab('tab6', this)">Trade Fairs</a>
                <a href="#" onclick="showTab('tab7', this)">Freight Quotes</a>
                <a href="#" onclick="showTab('tab8', this)">Newsletter</a>
            </div>
              
            <div class="col-md-1"></div>

            <div class="content col-md-7 mt-4">

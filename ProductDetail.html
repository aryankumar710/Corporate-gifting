        ...
        <div class="col-md-7  d-flex flex-column gap-product-detail1 ps-md-5 mt-4 mt-md-0">
          <div class="d-none d-md-block">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a class="text-decoration-none" href="CategoryYouMayLike.html"
          ...
          <div class="row">
            <div class="d-flex  mt-3 button-container">
              <a href="" class="btn  btn-md btn-primary me-1" type="button">Send Enquiry</a>
              <a href="ProductDetail.html" class="btn btn-md btn-outline-primary ms-1"
                type="button">Seller Detail
              </a>
            </div>
          </div>
        </div>
    ...
    <div class="container">
      ...
      <div class="row  gap-rate-review">
        ...
        <div class="col-md-6 mt-5 mt-md-0 d-flex flex-column align-items-end">
          <div>
            <a href="ProductDetail.html" class="btn primary-button btn-sm btn-primary ms-1" type="button">Rate Product
            </a>
          </div>
        ...
        <div class="mt-5">
          <div class="d-flex justify-content-center">
            <a href="ProductDetail.html" class="btn  btn-md btn-outline-primary me-1" type="button">Load More</a>
          </div>
        </div>
      </div>
    </div>

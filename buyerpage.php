...
<body>
        ...
        <div class="row">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active d-block" aria-current="page" style="color: #0068C8;">Post buy requirement</li>
                </ol>
            </nav>
        </div>
    </div>
  ...
  <section>
    <div class="container">
        <div class="row my-5">
            <div class="col-md-6">
                <h3>How to post buy requirement</h3>
                <div>
            ...
            <div class="col-md-6">
                <div class="product-form-container2">
                    ...
                    <form>
                      ...
                      <div class="form-floating-label col-12 mt-4">
                        <input type="text" class="form-control" id="mobilenumber" placeholder="" required>
                      ...
                      <div class="form-floating-label col-12 mt-4">
                        ...
                        <div class="invalid-feedback">
                          Please provide product name you are looking.
                        </div>
                      </div>
                        
                      <div class="form-floating-label col-12 mt-4">
                        <input type="text" class="form-control" id="productdescription" placeholder="" required>
                        <label for="productdescription">Product Description</label>
                        <div class="invalid-feedback">
                          Please provide product description you are looking.
                        </div>
                      </div>
